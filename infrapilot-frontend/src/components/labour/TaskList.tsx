...
const TaskList: React.FC<TaskListProps> = ({ tasks, onSelectTask }) => {
    ...
    const getPriorityInfo = (priority: string) => {
        ...
        switch (p) {
            case 'high': 
                return { color: 'text-rose-500 border-rose-100 bg-rose-50/50', label: 'High Priority' };
            case 'medium': 
                return { color: 'text-blue-500 border-blue-100 bg-blue-50/50', label: 'Medium Priority' };
            case 'low':
                return { color: 'text-emerald-500 border-emerald-100 bg-emerald-50/50', label: 'Low Priority' };
            default: 
                return { color: 'text-slate-400 border-slate-100 bg-slate-50/50', label: 'Low Priority' };
        }
    };
