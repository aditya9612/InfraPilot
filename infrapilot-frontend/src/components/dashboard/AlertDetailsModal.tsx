    ...
    >
      <div className="space-y-8 pb-4">
        ...
        <div className={`relative overflow-hidden rounded-2xl p-8 shadow-xl transition-all ${
          alert.status === "Critical" ? "bg-gradient-to-br from-rose-600 to-rose-700 text-white" :
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 relative z-10">
            ...
            <div className="text-center md:text-left">
              <div className="flex flex-col md:flex-row items-center gap-3">
                <h3 className="text-2xl font-black tracking-tight">{alert.type} Alert</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-slate-400">
                ...
                <h4 className="text-[11px] font-black uppercase tracking-widest">Target Audience</h4>
              </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm font-bold text-slate-700 pl-6 flex items-center gap-2">
                <span className={`w-2 h-2 rounded-full ${alert.isRead ? "bg-emerald-500" : "bg-primary animate-pulse"}`} />
                {alert.isRead ? "Marked as Read" : "Unread / Pending"}
              </p>
            </div>
          </div>
        </div>
