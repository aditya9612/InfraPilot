        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <input required type="text" name="site_location" value={formData.site_location || ""} onChange={handleChange} placeholder="e.g. Tower A - Basement" className={inputClasses(errors.site_location)} />
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea required name="work_planned" value={formData.work_planned || ""} onChange={handleChange} rows={2} className={`${inputClasses(errors.work_planned)} resize-none`} />
            </div>
          </div>
        </div>
