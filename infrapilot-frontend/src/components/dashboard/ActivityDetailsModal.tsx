...
const ActivityDetailsModal: React.FC<ActivityDetailsModalProps> = ({ isOpen, onClose, activity }) => {
  ...
  const footer = (
    <button
      onClick={onClose}
      className="px-8 py-2.5 bg-blue-600 border border-blue-600 text-white rounded-xl text-sm font-bold hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/20"
    >
      Close Details
    </button>
  );
