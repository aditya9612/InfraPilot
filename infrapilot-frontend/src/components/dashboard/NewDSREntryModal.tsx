...
//   // Sync project_id if it changes from parent
//   useEffect(() => {
...
//     if (!formData.work_planned.trim()) errs.work_planned = "Work Planned is required";
...
//                <div className="flex items-center gap-2 px-3 py-2 bg-slate-100 rounded-lg text-xs font-bold text-slate-600">
//                   <span className={`w-2 h-2 rounded-full ${gpsStatus === 'captured' ? 'bg-success' : gpsStatus === 'capturing' ? 'bg-warning animate-pulse' : 'bg-red-500'}`}></span>
//                   GPS: {gpsStatus.toUpperCase()}
//                   <button type="button" onClick={captureGPS} className="ml-2 text-primary hover:underline">Recapture</button>
//                </div>
//             </div>
//           </div>
//         </div>
...
//             <div>
//               <label className="block text-xs font-bold text-slate-500 mb-1">
//                 Work Planned for Tomorrow <span className="text-red-500">*</span>
//               </label>
//               <textarea
//                 required
//                 name="work_planned"
...
//                 rows={2}
//                 className={`w-full px-3 py-2 bg-slate-50 border ${errors.work_planned ? "border-red-500" : "border-slate-200"} rounded-lg text-sm outline-none transition-all resize-none`}
//               />
//             </div>
//           </div>
//         </div>
...
const NewDSREntryModal = ({
  ...
  const validate = () => {
    ...
    if (!formData.contractor_id) errs.contractor_id = "Contractor is required";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-end pb-1">
              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-2 px-3 py-2 bg-slate-100 rounded-lg text-xs font-bold text-slate-600">
                  <span
                    className={`w-2 h-2 rounded-full ${gpsStatus === "captured"
                        ? "bg-success"
                        : gpsStatus === "capturing"
