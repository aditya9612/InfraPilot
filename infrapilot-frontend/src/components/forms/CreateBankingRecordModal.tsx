          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2.5 ${formData.type === "cash" ? "bg-slate-100 cursor-not-allowed" : "bg-slate-50"} border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-primary/20 outline-none`}
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                type="text"
                disabled={formData.type === "cash"}
                className={`w-full px-4 py-2.5 ${formData.type === "cash" ? "bg-slate-100 cursor-not-allowed" : "bg-slate-50"} border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-primary/20 outline-none uppercase`}
            ...
            <div>
              ...
              <input
                type="number"
                min="0"
                className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-primary/20 outline-none font-bold text-slate-900"
