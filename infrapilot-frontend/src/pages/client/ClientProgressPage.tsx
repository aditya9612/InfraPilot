          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50/50 border-b border-slate-100">
                ...
                <th className="p-4 text-[10px] font-bold text-slate-400 uppercase tracking-widest">Delay</th>
                ...
                <tr key={i} className="hover:bg-slate-50/50 transition-colors group">
                  ...
                  <td className="p-4 w-48">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-[10px] font-bold text-slate-700 w-8">{act.progress}%</span>
                    </div>
                  </td>
                  <td className="p-4">
                  ...
                  <td className="p-4">
                    <span className={`text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 rounded-full ${act.delay === "None" ? "bg-slate-50 text-slate-400" : "bg-red-50 text-red-600"}`}>{act.delay}</span>
                  </td>
                  <td className="p-4 pr-8">
                    <div className="flex items-center gap-2">
                       ...
                       <span className="text-[10px] font-bold text-slate-600 uppercase tracking-widest">{act.status}</span>
                    </div>
                  </td>
                </tr>
              ))}
