...
const ReportCard = ({ level, title, desc, stats, size, onPDF, onExcel, colorClass, icon }: any) => (
  <div className="bg-white rounded-[32px] border border-slate-100 shadow-sm hover:shadow-xl transition-all flex flex-col h-full overflow-hidden group font-inter">
    ...
    <div className="mt-auto p-8 pt-4 border-t border-slate-50 flex items-center justify-between">
      <div className="flex items-center gap-2">
        ...
        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest whitespace-nowrap">Today, 08:30 AM</p>
...
const ClientReportsPage = () => {
  ...
  const fetchAllReports = async () => {
    ...
    try {
      ...
      setLabourSummary(labour.labour_summary || []);
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 pt-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
          ...
          <button
            ...
            className="bg-white hover:bg-slate-50 px-6 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center gap-3 border border-slate-200 active:scale-95 shadow-sm text-slate-600 whitespace-nowrap"
          >
          ...
          <div className="flex-grow grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
            <div className="relative">
              ...
              <div className="relative">
                ...
                <input type="text" placeholder="Search reports..." className="w-full bg-slate-50/50 border border-slate-100 rounded-2xl pl-11 pr-4 py-4 text-xs font-bold text-slate-700 focus:outline-none focus:ring-4 focus:ring-blue-500/5 focus:border-blue-500/20 transition-all placeholder:text-slate-300" />
              </div>
            </div>
            <div className="relative">
            ...
            <div className="relative">
              ...
              <select className="w-full bg-slate-50/50 border border-slate-100 rounded-2xl px-5 py-4 text-xs font-bold text-slate-700 focus:outline-none appearance-none cursor-pointer">
