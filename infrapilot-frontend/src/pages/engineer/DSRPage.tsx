...
//               onClick={() => { setSubmitted(false); setActiveSection("basic"); setForm(f => ({ ...f, date: today })); }}
//             >
//               + New Report
//             </button>
//           </div>
...
//                 className={`flex items-center gap-1.5 px-4 py-3 text-xs font-bold whitespace-nowrap border-b-2 transition-all flex-1 justify-center ${
//                   activeSection === s.id
