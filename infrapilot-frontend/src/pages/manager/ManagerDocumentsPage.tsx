...
const ManagerDocumentsPage = () => {
    ...
    const [typeFilter, setTypeFilter] = useState<"All" | "Documents">("All");
    ...
    useEffect(() => {
        if (tab) {
            const tabMap: Record<string, "All" | "Documents"> = {
                documents: "Documents",
                files: "All",
                drawings: "All",
                contracts: "All",
    ...
    const filtered = useMemo(() => {
        ...
        if (mainTab === "Drawings") {
            data = data.filter(d => (d.document_type || "").toLowerCase() === "drawing");
        }
