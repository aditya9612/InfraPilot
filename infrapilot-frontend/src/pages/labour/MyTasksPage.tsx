                                ...
                                {filteredTasks.map(task => (
                                    ...
                                    >
                                        <div className="space-y-4">
                                            ...
                                            <div>
                                                <h3 className="text-sm font-black text-slate-800 group-hover:text-indigo-600 transition-colors line-clamp-2">{task.title}</h3>
                                            ...
                                            <div className="flex items-center gap-3 py-2">
                                                ...
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="text-[9px] font-bold text-slate-400">Assigned by {task.assignedBy}</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-6 pt-4 border-t border-slate-50 space-y-4">
                                            <div className="flex items-center justify-between text-[10px] font-bold text-slate-400">
                                                <div className="flex items-center gap-1.5">
                                                    ...
                                                    <span>{task.deadline === 'Invalid Date' ? 'N/A' : new Date(task.deadline).toLocaleDateString('en-GB', { day: '2-digit', month: 'short' })}</span>
                                                </div>
