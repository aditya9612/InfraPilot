...
const InventoryPage = () => {
  ...
  const [itemToDelete, setItemToDelete] = useState<{ id: any; type: "material" | "supplier" } | null>(null);
  ...
  const handlePurchaseAction = (data: any) => {
    ...
    toast.success(data.actionType === "usage" ? "Usage logged successfully!" : "Purchase added successfully!");
  };
