                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className="relative">
                          <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${alert.type === "Delay" ? "bg-amber-50 text-amber-600" : alert.type === "Budget" ? "bg-rose-50 text-rose-600" : "bg-blue-50 text-blue-600"
                            }`}>
                            {alert.type === "Delay" ? (
