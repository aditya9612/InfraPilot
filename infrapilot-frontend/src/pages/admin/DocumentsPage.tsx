...
const initialDocuments = [
  ...
  {
    id: 2,
    name: "Cement Supply Invoice #882",
    type: "Invoice",
    project: "Metro Ph-II",
    version: "v1.0",
    status: "Pending",
...
const DocumentsPage = () => {
  ...
  const handleDownload = (doc: any) => {
    if (doc.isFolder) {
      toast.error(
        "Cannot download a folder directly. Please download individual files.",
      );
      return;
    }
      ...
      <PageTransition className="p-6 bg-slate-50 min-h-screen">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-slate-500 text-sm">
              Securely store and manage blueprints, contracts, and financial
              records.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <StatCard
            ...
            sub="Active files in repository"
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div
                          className={`w-8 h-8 ${doc.isFolder ? "bg-amber-100 text-amber-600" : "bg-slate-100 text-slate-500"} rounded-lg flex items-center justify-center`}
                        >
                          {doc.isFolder ? (
                            <Folder size={16} />
                          ) : (
