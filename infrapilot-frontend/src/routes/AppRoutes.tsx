  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/admin/users" element={<ProtectedRoute allowedRoles={["Admin"]}><ComingSoon /></ProtectedRoute>} />
        <Route path="/admin/reports" element={<ProtectedRoute allowedRoles={["Admin"]}><ComingSoon /></ProtectedRoute>} />
        <Route path="/admin/settings" element={<ProtectedRoute allowedRoles={["Admin"]}><ComingSoon /></ProtectedRoute>} />

        {/* Manager Pages */}
        <Route path="/manager/projects" element={<ProtectedRoute allowedRoles={["Project Manager"]}><ProjectsPage /></ProtectedRoute>} />
        <Route path="/manager/boq" element={<ProtectedRoute allowedRoles={["Project Manager"]}><ComingSoon /></ProtectedRoute>} />
        <Route path="/manager/labour" element={<ProtectedRoute allowedRoles={["Project Manager"]}><ComingSoon /></ProtectedRoute>} />
        <Route path="/manager/materials" element={<ProtectedRoute allowedRoles={["Project Manager"]}><ComingSoon /></ProtectedRoute>} />

        {/* Contractor Pages */}
        <Route path="/contractor/orders" element={<ProtectedRoute allowedRoles={["Contractor"]}><ComingSoon /></ProtectedRoute>} />
        <Route path="/contractor/invoices" element={<ProtectedRoute allowedRoles={["Contractor"]}><ComingSoon /></ProtectedRoute>} />
        <Route path="/contractor/documents" element={<ProtectedRoute allowedRoles={["Contractor"]}><ComingSoon /></ProtectedRoute>} />

        {/* Accountant Pages */}
        <Route path="/accountant/budget" element={<ProtectedRoute allowedRoles={["Accountant"]}><ComingSoon /></ProtectedRoute>} />
        <Route path="/accountant/invoices" element={<ProtectedRoute allowedRoles={["Accountant"]}><ComingSoon /></ProtectedRoute>} />
        <Route path="/accountant/payments" element={<ProtectedRoute allowedRoles={["Accountant"]}><ComingSoon /></ProtectedRoute>} />
        <Route path="/accountant/reports" element={<ProtectedRoute allowedRoles={["Accountant"]}><ComingSoon /></ProtectedRoute>} />

        {/* Client Pages */}
        <Route path="/client/progress" element={<ProtectedRoute allowedRoles={["Client"]}><ComingSoon /></ProtectedRoute>} />
        <Route path="/client/photos" element={<ProtectedRoute allowedRoles={["Client"]}><ComingSoon /></ProtectedRoute>} />
        <Route path="/client/documents" element={<ProtectedRoute allowedRoles={["Client"]}><ComingSoon /></ProtectedRoute>} />
